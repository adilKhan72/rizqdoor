...
<main  class="col-md-9 ml-sm-auto col-lg-10 px-4">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    You are editing "<?php
    $joblist = $joblist1[0];
    echo $joblist->companybranchname;
    ?>"
    </h1>
     <?php 
if($companyupdated= $this->session->flashdata('companyupdated')){
...
<?php
      ...
      <div class="row">
        <div class="col-md-12"> 
            <?php  $attributes1 = array('id' => 'addmoreinfocommm'); echo form_open('employer/editcompanydetailssubmit',$attributes1);  ?>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="companybranchname"  value="<?= $joblist->companybranchname?>">
  </div>
...
//<![CDATA[
  ...
  <textarea style="width:100%; min-height:150px;" class="form-control" name="compinfo" required="" placeholder=" Write a Brief Job discription" class="textarea" id="area5"><?=$joblist->compinfo?>
  </textarea>
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">how many employees</label>
    <?php echo form_error('howmanyemployees'); ?>
    <input type="text" class="form-control" name="howmanyemployees"  value="<?= $joblist->howmanyemployees?>">
  </div>
   <div class="form-group">
...
<select name="companyfield" class="form-control" aria-describedby="emailHelp" placeholder="Specify company industory">
<option value="<?= $joblist->companyfield?>"><?= $joblist->companyfield?></option>
...
<option value="Writing and Editing">Writing and Editing</option>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="address"  value="<?= $joblist->address?>">
  </div>
<div class="form-row">
...
<select id="" class="form-control" name="countrycode">
  <option value="<?= $joblist->countrycode?>"><?= $joblist->countrycode?></option>
  ...
  <div class="form-group col-md-10">
    ...
    <input type="number" class="form-control" name="phone"  value="<?= $joblist->phone?>">
  </div>
</div>
