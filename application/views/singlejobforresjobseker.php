...
<h5 style=" color:grey;  color:#379683; font-size: 1.25rem; font-weight: 500;  padding-bottom: 5px; ">
      ...
      if($singlejob->userjobseekerid == $user){
      ?>
        <span style="color:grey;">Already Applied At : <?= $singlejob->applieddate; ?></span>
      <?php
      }else{
      ?>
...
">View Company Profile</a>
      ...
      ?>
          <a class="button" href="<?= base_url("users/easyapply/".$singlejob1);?>" title="" style="
text-decoration: none;
color:white;
padding: 10px 0px;
    background-color: #379683;; /* Green */
