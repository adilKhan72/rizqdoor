...
<html lang="en">
  ...
  <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0 " href="<?= base_url('blog/admin_dashboard'); ?>" style="overflow: auto; font-family: monospace; font-size: 1.3em;">
     <i id="logo" class="icon-LOGO" style="">iqDoor</i>
</a>
      <input class="form-control form-control-dark w-100" type="text" placeholder="Search" aria-label="Search">
      <ul class="navbar-nav px-3">
        <li class="nav-item text-nowrap">
          <a class="nav-link" href="<?= base_url('blog/logout'); ?>">Sign out</a>
        </li>
      </ul>
    </nav>