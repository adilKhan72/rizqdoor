...
<div class="main-div jobcategory"><!--country category start-->
  <div class="main-login">
    <h1 class="country " style="padding-bottom:20px; ">JobSeeker Log in here!</h1>
    ...
    <div class="formdiv">
     ...
     <?php  $attributes1 = array('id' => 'emplogin');
      echo form_open('users/loginsubmit', $attributes1 ); ?>
     ...
     if($signupsuccess = $this->session->flashdata('signupsuccess'))
       {?>
        ...
        <p class="afterheading">
          ...
          <a href="<?= base_url('users/signup'); ?>">Register here!</a>
        </p>
...
?>
      <label class="container">Keep me Logged In!
        ...
        <span class="frgtpass"><a href="<?= base_url('users/forgotpassword'); ?>">Forgot password?</a></span>
      </label>
<?php
}else{
?>
