...
<div class="main-div jobcategory"><!--country category start-->
  <div class="main-login">
    <h1 class="country " style="padding-bottom:20px; ">JobSeeker Sign up here!</h1>
    <p class="afterheading">Already have an Account?
     <a href="<?= base_url('users/login'); ?>">Log In!</a></p>
     <div class="formdiv">
     
    <form action="<?= base_url('users/signupsubmit'); ?>" id="userjobseekersignup" enctype="multipart/form-data" method="post" accept-charset="utf-8">
...
?>
<p style="font-size:0.9em; color:#363636;">Enter date of birth below</p>
<?php
$data1 = array(
        'name'          => 'dateofbirth',
...
?>
<select name="gender">
        <option value="" <?php echo  set_select('gender', '', TRUE); ?> >Gender Preference</option>
...
echo form_error('mobilenumber');
      ...
      $data = array(
        'name'          => 'landlinenumber',
        'value'         => set_value('landlinenumber'),
        'type'          => 'number',
        'required'=>'',
...
?>
<select name="industory" class="form-control" aria-describedby="emailHelp" placeholder="Specify company industory">
<option value="">Specify Prefered Industory</option>
...
<select name="currencytype">
    <option value="" selected="selected">Currency Type for Salary</option>
...
?>
<input type="file" name="cvupload" id="cvupload" required="" class="inputfile inputfile-6"  onchange="return fileValidationforjobseekerdashboard()" />
